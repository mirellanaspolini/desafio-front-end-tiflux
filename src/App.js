import { BellOutlined, LoadingOutlined, RocketOutlined, SearchOutlined, StarOutlined, TeamOutlined } from '@ant-design/icons';
			...
			<Col span={18}>
				<main style={{padding: '3rem'}}>
					<Header>
						...
						<div className="menuUser">
							...
							<div>
								...
								<Paragraph style={{margin: 0}}>User</Paragraph>
							</div>
						</div>
					</Header>
					...
					<div className="btnCard-Wrapper">
						{buttons.map((button) => <ButtonComponent {...button} fetchData={fetchData} /> )}
					</div>
					
					{loading && <LoadingOutlined style={{margin:"3rem", display: 'block', fontSize: "1.5rem"}}/>}
					{!data ? null : 
						<Card>
							<Header>
							...
							<Table style={{overflowX: "scroll"}}  dataSource={data} columns={column} />
						</Card>
				 	}
				</main>
			</Col>
